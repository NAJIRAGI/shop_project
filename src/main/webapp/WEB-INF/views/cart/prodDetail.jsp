				...
				<div class="col-xl-7 col-lg-7 col-md-6">
					<div class="single-product-details">
						...
						<ul>
							<li>
								<div class="form-group quantity-box">
									...
									<input class="form-control" value="0" min="0" max="20" type="number" id="count">
								</div>
							</li>
						</ul>
						...
						<div class="price-box-bar">
							...
							<c:choose>
							<c:when test="<%=cnt == 0%>">					
									<button type="button" class="btn hvr-hover" name="submit" id="btn-cart">Add to Cart</button>						
							</c:when>
							<c:otherwise>								
									<button type="button" class="btn hvr-hover">Contained</button>								
							</c:otherwise>
						</c:choose>						
							<button type="button" class="btn hvr-hover" onclick="history.back()">Back</button>							
							</div>
						</div>
					</div>
				</div>
