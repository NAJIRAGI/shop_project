						...
						<ul>
							<c:choose>
								<c:when test="${!empty principal}">
									<li><p><a class="btn hvr-hover" href="/logout">LOG OUT</a></p></li>
								</c:when>
								<c:otherwise>
									<li><p><a class="btn hvr-hover" href="/auth/loginForm">LOGIN</a></p></li>											
								</c:otherwise>
							</c:choose>
				...
				<!-- Collect the nav links, forms, and other content for toggling -->
				  <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">MY</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-all text-center">
						<h1>Fruits의 수입 상품</h1>
						<p>국내에서 만나볼 수 없는 신비한 과일들을 만나보세요!</p>
					</div>
				</div>
			</div>			
			...
			<div class="row special-list">
				<c:forEach var="prod" items="${products.content}">
					<c:if test="${prod.origin == 1}">
						<div class="col-lg-3 col-md-6 special-grid best-seller">
							<div class="products-single fix">
								<div class="box-img-hover">
									<img src="../${prod.prodImgPath}" class="img-fluid" alt="Image">
									<div class="mask-icon">
										<a class="cart" href="/cart/${prod.productId}/prodDetail">Add to Cart</a>
									</div>
								</div>
								<div class="why-text">
